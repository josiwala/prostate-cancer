...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\Large Individual Research Study}\\[0.5cm] % Major heading such as course name
	\textsc{\large Department of Mathematics and Statistics}\\[0.5cm] % Minor heading such as course title
	October 22, 2020\\ % Date, change the \today to a set date if you want to be precise
